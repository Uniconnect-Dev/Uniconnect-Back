...
public class SignatureService {
    ...
    public void saveSignature(SignatureRequest req, Long userId) {
        ...
        // 4. 서명 값 검증
        if (!serverHash.equals(req.getSignatureHash())) {
